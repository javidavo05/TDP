...
export default function POSLoginPage() {
  ...
  useEffect(() => {
    ...
    if (savedCreds && (savedCreds.role === "pos_agent" || savedCreds.role === "admin")) {
      router.push("/pos");
    }
  }, [router]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Only allow pos_agents and admins
      ...
      // If pos_agent, get their terminal
      if (role === "pos_agent") {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 p-4">
      <div className="w-full max-w-md bg-card rounded-2xl shadow-lg p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2">TDP POS</h1>
