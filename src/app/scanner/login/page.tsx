...
export default function ScannerLoginPage() {
  ...
  useEffect(() => {
    ...
    if (savedCreds && (savedCreds.role === "driver" || savedCreds.role === "assistant" || savedCreds.role === "admin")) {
      router.push("/scanner");
    }
  }, [router]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Only allow drivers, assistants, and admins
      if (role !== "driver" && role !== "assistant" && role !== "admin") {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 p-4">
      <div className="w-full max-w-md bg-card rounded-2xl shadow-lg p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2">TDP Scanner</h1>
